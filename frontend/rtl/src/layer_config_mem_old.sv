...
// Historical hardcoded-profile implementation kept for reference only.
// The formal design uses layer_config_mem.sv backed by sync_rom/init file.
module layer_config_mem_old #(
    ...
    localparam int NUM_ROM_LAYERS = LAYER_CONFIG_DEPTH;
