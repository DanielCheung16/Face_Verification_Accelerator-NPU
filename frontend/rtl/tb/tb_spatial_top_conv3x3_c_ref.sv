...
module tb_spatial_top_conv3x3_c_ref;
    ...
    localparam int OUTPUTS = OUT_SIZE * OUT_SIZE * OC;
    localparam int OUTPUT_WORDS = OUTPUTS / LANES;
    localparam int MEM_DEPTH = 330000;
    localparam int PARAM_DEPTH = 64;
    localparam int OUT_BASE = 300000;
    localparam int FILTER_CNT_W = $clog2(WGT_DEPTH * LANES) + 1;

    localparam string AO_INIT_FILE = "gold_models/qface_c/generated/spatial_top_conv3x3_ao_init.txt";
    localparam string WGT_INIT_FILE = "gold_models/qface_c/generated/spatial_top_conv3x3_wgt_init.txt";
    localparam string EXPECTED_FILE = "gold_models/qface_c/generated/spatial_top_conv3x3_expected.txt";
    localparam string BIAS_INIT_FILE = "gold_models/qface_c/generated/spatial_top_conv3x3_bias.hex";
    localparam string REQUANT_MULT_INIT_FILE = "gold_models/qface_c/generated/spatial_top_conv3x3_requant_mult.hex";
    localparam string REQUANT_SHIFT_INIT_FILE = "gold_models/qface_c/generated/spatial_top_conv3x3_requant_shift.hex";
    localparam string PRELU_MULT_INIT_FILE = "gold_models/qface_c/generated/spatial_top_conv3x3_prelu_mult.hex";
    localparam string PRELU_SHIFT_INIT_FILE = "gold_models/qface_c/generated/spatial_top_conv3x3_prelu_shift.hex";
    localparam string RESIDUAL_MULT_INIT_FILE = "gold_models/qface_c/generated/spatial_top_conv3x3_residual_mult.hex";
    localparam string RESIDUAL_SHIFT_INIT_FILE = "gold_models/qface_c/generated/spatial_top_conv3x3_residual_shift.hex";
    localparam string RESIDUAL_ZERO_POINT_INIT_FILE = "gold_models/qface_c/generated/spatial_top_conv3x3_residual_zero_point.hex";
    ...
    initial begin
        ...
        if (fail_cnt != 0) begin
            $fatal(1, "[TB] spatial_top Conv3x3 C-ref FAILED fail=%0d", fail_cnt);
        end
        $display("[TB] spatial_top Conv3x3 C-ref PASSED words=%0d", write_cnt);
        $finish;
    end
