...
exec sh -c "cd gold_models/qface_c && ./dump_system_2_2 generated/system_2_2_seq0 5"
...
vsim -c -t 1ns -classdebug -voptargs=+acc +notimingchecks -L work work.tb_top_system_2_2_c_ref -gPROFILE=5 -wlf tb_top_system_2_2_seq0_c_ref.wlf
