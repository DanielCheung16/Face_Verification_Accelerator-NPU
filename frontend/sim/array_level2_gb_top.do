...
vlog -sv -work work "../rtl/tb/tb_array_level2_gb_top.sv"

vsim -c -t 1ns -classdebug -voptargs=+acc +notimingchecks -L work work.tb_array_level2_gb_top -GROW=$ROW -GCOL=$COL -GK_MAX=$K_MAX -GSINGLE_CASE=$SINGLE_CASE -GM_SIZE=$M -GK_SIZE=$K -GN_SIZE=$N -GM_MAX=$M_MAX -GN_MAX=$N_MAX -GSTALL_MODE=0 -wlf tb_array_level2_gb_top_nostall.wlf

onfinish stop
run -all

vsim -c -t 1ns -classdebug -voptargs=+acc +notimingchecks -L work work.tb_array_level2_gb_top -GROW=$ROW -GCOL=$COL -GK_MAX=$K_MAX -GSINGLE_CASE=$SINGLE_CASE -GM_SIZE=$M -GK_SIZE=$K -GN_SIZE=$N -GM_MAX=$M_MAX -GN_MAX=$N_MAX -GSTALL_MODE=1 -wlf tb_array_level2_gb_top_stall.wlf
