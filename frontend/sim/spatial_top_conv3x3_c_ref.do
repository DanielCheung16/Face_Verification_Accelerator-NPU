...
vlog -sv -work work "../rtl/tb/tb_spatial_top_conv3x3_c_ref.sv"

vsim -c -t 1ns -classdebug -voptargs=+acc +notimingchecks -L work work.tb_spatial_top_conv3x3_c_ref -wlf tb_spatial_top_conv3x3_c_ref.wlf
run -all
quit
