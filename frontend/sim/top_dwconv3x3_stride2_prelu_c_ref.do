...
exec sh -c "cd gold_models/qface_c && ./dump_spatial_top_dw 3"
...
vsim -c -t 1ns -classdebug -voptargs=+acc +notimingchecks -L work work.tb_top_dwconv3x3_prelu_c_ref -gPROFILE=7 -gOUT_SIZE=28 -gC=128 -gSPATIAL_WGT_DEPTH=8 -wlf tb_top_dwconv3x3_stride2_prelu_c_ref.wlf
