...
exec make -C gold_models/qface_c dump_spatial_top_conv3x3
exec sh -c "cd gold_models/qface_c && ./dump_spatial_top_conv3x3"
...
vlog -sv -work work "../rtl/tb/tb_top_conv3x3_c_ref.sv"

vsim -c -t 1ns -classdebug -voptargs=+acc +notimingchecks -L work work.tb_top_conv3x3_c_ref -wlf tb_top_conv3x3_c_ref.wlf
