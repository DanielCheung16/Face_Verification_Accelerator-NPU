...
exec gold_models/quantface_conv1x1_c_ref/dump_sram_hex gold_models/quantface_conv1x1_c_ref/out_prelu prelu
...
vlog -sv -work work "../rtl/tb/tb_top_conv1x1_prelu_c_ref.sv"

vsim -c -t 1ns -classdebug -voptargs=+acc +notimingchecks -L work work.tb_top_conv1x1_prelu_c_ref -wlf tb_top_conv1x1_prelu_c_ref.wlf
