...
vlog -sv -work work "../rtl/tb/tb_spatial_top_dw_csv.sv"

vsim -c -t 1ns -classdebug -voptargs=+acc +notimingchecks -L work work.tb_spatial_top_dw_csv -wlf tb_spatial_top_dw_csv.wlf
run -all
quit
