...
exec sh -c "cd gold_models/qface_c && ./dump_system_2_2 generated/system_3_2_conv3x3_dw 10"
...
vsim -c -t 1ns -classdebug -voptargs=+acc +notimingchecks -L work work.tb_top_system_2_2_c_ref -gPROFILE=10 -wlf tb_top_conv3x3_dw_c_ref.wlf
