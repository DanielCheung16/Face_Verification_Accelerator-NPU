...
exec sh -c "cd gold_models/qface_c && ./dump_system_2_2 generated/full_model_hw_spec 13"
...
vsim -c -t 1ns -classdebug -voptargs=+acc +notimingchecks -L work work.tb_top_system_2_2_c_ref -gPROFILE=13 -wlf tb_top_full_model_hw_spec_c_ref.wlf
