...
exec gold_models/quantface_conv1x1_c_ref/dump_sram_hex gold_models/quantface_conv1x1_c_ref/out two_layer
...
vsim -c -t 1ns -classdebug -voptargs=+acc +notimingchecks -L work work.tb_top_quantface_conv1x1_closed_loop -wlf tb_top_conv1x1_two_layer_c_ref.wlf
