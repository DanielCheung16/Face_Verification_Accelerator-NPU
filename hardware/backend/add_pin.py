...
def add_pg_pins(input_file, output_file):
    """Add inout VDD/VSS ports to mfn_frontend_top module for Innovus power routing."""
    with open(input_file, 'r') as f:
        content = f.read()

    # Match module mfn_frontend_top(...)
    # Use re.DOTALL to match across multiple lines
    module_pattern = r'(module\s+mfn_frontend_top\s*\()([^)]*)(\);)'
    ...
    inout_pattern = r'(module\s+mfn_frontend_top\s*\(.*?\);)'
