...
# v3 RTL = 4-stage activation + Stage 3 SA pipeline.
# 5.75 ns post-route closed with WNS +0.565 ns; the critical path is now
#   u_act_buf/act_out_reg → CSA tree (mult fused) → u_sa/row_dot_reg
# at 5.503 ns.  5.0 ns leaves ~0 ns headroom — if fails, Stage 3.5
# (register the 144 individual products) is the next step.
# ============================================================
