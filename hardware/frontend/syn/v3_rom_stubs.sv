...
// ── act_buf SRAM leaf cell (1RW, 16-bit × 512 words) ─────────────────────────
// Generated by OpenRAM for FreePDK45.
// word_size=16, num_words=512, write_size=8 → wmask0 is 2 bits (2 bytes).
// Synthesis black-box: dont_touch on u_act_buf in synthesis_v3.tcl.
// For simulation: use sv3/mfn_act_buf.sv (FF-based behavioral model).
// For P&R: LEF = sram_generation/macro/sram_act_buf_1rw0r0w_16_512_freepdk45.lef
//          LIB = syn/lib/sram_act_buf_1rw0r0w_16_512_freepdk45.lib (from OpenRAM)
module sram_act_buf_1rw0r0w_16_512_freepdk45 (
    input        clk0, csb0, web0,
    input  [1:0] wmask0,    // 2 mask bytes (16 bits / write_size 8)
    input  [8:0] addr0,     // 9-bit: ceil(log2(512))
    input  [15:0] din0,
    output [15:0] dout0
);
endmodule
